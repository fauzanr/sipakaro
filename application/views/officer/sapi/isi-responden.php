        ...
        <div style="text-align: center;">
            ...
            <form action="<?php echo base_url().'officer/input_ahp_sapi_dua' ?>" method="post">
                <div class="btn-group btn-group-toggle btn-block col-md-8" data-toggle="buttons">
                    <?php for ($i=1 ; $i <= 5 ; $i++) : ?>
                        <label class="btn btn-primary btn-lg mr-2 <?= isset($_SESSION['pengisian_ahp_sapi']['responden']) && $_SESSION['pengisian_ahp_sapi']['responden']==$i ? '' : '' ?>">
